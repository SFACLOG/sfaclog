...
const page = () => {
  return (
    <div>
      <LoginLayout title='이용약관&개인정보처리방침' color='text-neutral-100'>
        <div className='w-full font-semibold mb-[55px]'>
          <p className='mb-[15px]'>서비스 이용약관</p>
          <div className='border px-[16px] py-5  text-neutral-60 whitespace-pre-line h-[375px] overflow-y-auto'>
            {`[스팩로그 이용약관]
제1조 (목적)
본 약관은 [스팩로그]가 제공하는 블로그 서비스(이하 "서비스")의 이용과 관련하여 [스팩로그]와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
제2조 (용어의 정의)
...
본 이용약관은 [스팩로그]와 이용자 간의 상호 이해를 돕고 서비스 이용에 필요한 기본적인 규칙을 정하는 것을 목적으로 합니다. 이용자는 이 약관을 주의 깊게 읽고 동의한 뒤 서비스를 이용해 주시기 바랍니다. 약관에 동의하지 않을 경우 서비스 이용이 제한될 수 있습니다.`}
        ...
        <div className='w-full font-semibold'>
          <p className='mb-[15px]'>개인정보처리방침</p>
          <div className='border px-[16px] py-5  text-neutral-60 whitespace-pre-line h-[375px] overflow-y-auto'>
            {`[스팩로그 개인정보처리방침]
